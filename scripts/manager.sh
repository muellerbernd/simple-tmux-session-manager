#!/usr/bin/env bash
# inspired by https://github.com/mislav/dotfiles/blob/d2af5900fce38238d1202aa43e7332b20add6205/bin/tmux-session
...
restore() {
  ...
  tmux display-message "restored $count sessions"
}
